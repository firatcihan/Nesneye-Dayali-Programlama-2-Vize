...
public class Main {
    ...
    public static void ornekVeriEkle(BiletSistemi biletSistemi) {
        var film1 = new Film("Hızlı ve Öfkeli: Tokyo Yarışı", "Aksiyon/Suç", 104, "Justin Lin");
        var film2 = new Film("Oppenheimer", "Gerilim/Dönem İşi", 180, "Christopher Nolan");
        var film3 = new Film("Yaralı Yüz", "Suç/Gerilim", 165, "Brian De Palma");

        biletSistemi.filmListesineEkle(film1);
        biletSistemi.filmListesineEkle(film2);
        biletSistemi.filmListesineEkle(film3);

        var musteri1 = new Musteri("Fırat", "Aktif", "firat@hotmail.com", "5555555555");
        var musteri2 = new Musteri("Cihan", "Pasif", "cihan@hotmail.com", "5444444444");
        ...
        var salon2 = new Salon("Salon B", "Pasif", 150, "4DX", film2);
